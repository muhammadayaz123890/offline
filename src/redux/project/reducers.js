...
const initialStateFilter = {
  data: staticData,
  countOpen: staticData.length,
  countProgress: staticData.filter((data) => data.status !== 'completada').length,
  countCompleted: staticData.filter((data) => data.status === 'completada').length,
  loading: false,
  error: null,
};
