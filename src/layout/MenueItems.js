...
function MenuItems({ toggleCollapsed }) {
  ...
  const items = [
    getItem(t('dashboard'), 'dashboard', !topMenu && <UilCreateDashboard />, [
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-2`}>
          {t('demo')} {t('2')}
        </NavLink>,
        'demo-2',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-3`}>
          {t('demo')} {t('3')}
        </NavLink>,
        'demo-3',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-4`}>
          {t('demo')} {t('4')}
        </NavLink>,
        'demo-4',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-5`}>
          {t('demo')} {t('5')}
        </NavLink>,
        'demo-5',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-6`}>
          {t('demo')} {t('6')}
        </NavLink>,
        'demo-6',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-7`}>
          {t('demo')} {t('7')}
        </NavLink>,
        'demo-7',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-8`}>
          {t('demo')} {t('8')}
        </NavLink>,
        'demo-8',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-9`}>
          {t('demo')} {t('9')}
        </NavLink>,
        'demo-9',
        null,
      ...
      getItem(
        <NavLink onClick={toggleCollapsed} to={`${path}/dashboard/demo-10`}>
          {t('demo')} {t('10')}
        </NavLink>,
        'demo-10',
        null,
